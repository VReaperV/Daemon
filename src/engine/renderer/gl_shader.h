...
class GLShaderManager
{
	...
	std::vector<GLint> _worldDataShaders;
	int       _totalBuildTime;
...
class GLBuffer {
	...
	void BufferStorage( const GLenum target, const GLsizeiptr newAreaSize, const uint areaCount, const void* data ) {
	...
	uint32_t* GetAreaData( const uint areaID ) {
		ASSERT_LT( areaID, maxAreas );
		return data + areaID * areaSize;
	}
...
class GLSSBO : public GLBuffer {
	...
	void BufferStorage( const GLsizeiptr areaSize, const uint areaCount, const void* data ) {
...
class GLUBO : public GLBuffer {
	public:
	GLUBO( const char* name, const GLuint bindingPoint, const GLbitfield flags, const GLbitfield mapFlags ) :
		GLBuffer( name, bindingPoint, flags, mapFlags ) {
	}
...
class GLAtomicCounterBuffer : public GLBuffer {
	public:
	GLAtomicCounterBuffer( const char* name, const GLuint bindingPoint, const GLbitfield flags, const GLbitfield mapFlags ) :
		GLBuffer( name, bindingPoint, flags, mapFlags ) {
	}
