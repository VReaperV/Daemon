...
#include "Material.h"
	...
	Cvar::Cvar<bool> r_gpuFrustumCulling( "r_gpuFrustumCulling", "Use frustum culling on the GPU for Material System", Cvar::NONE, true );
	...
	Cvar::Cvar<bool> r_texturePacks( "r_texturePacks", "pack 2d textures into texture arrays; more memory usage, but better performance", Cvar::NONE, true );
